...
#_akg_btn:hover { transform: scale(1.02); box-shadow: 0 0 25px rgba(168, 85, 247, 0.6); }

#_akg_err { color: #f87171; font-size: 12px; margin-bottom: 10px; min-height: 16px; }
#_akg_circle_wrap { display: none; flex-direction: column; align-items: center; margin-bottom: 16px; }
#_akg_status { font-size: 12px; color: #00f2fe; letter-spacing: 1px; margin-top: 12px; font-weight: bold; }
