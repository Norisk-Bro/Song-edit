...
style.textContent=`
@import url("https://fonts.googleapis.com/css2?family=Syncopate:wght@700&family=Oxanium:wght@400;700;800&family=Inter:wght@400;600;800&display=swap");
...
/* Professional Elite Rotating RGB Neon Border */
#_akg_box::before {
    content: ''; position: absolute; top: -50%; left: -50%; width: 200%; height: 200%;
    background: conic-gradient(from 0deg, transparent 20%, #00f2fe, #4facfe, #00f2fe, transparent 80%);
    animation: professional-rotate 4s linear infinite; z-index: -1;
}
...
#_akg_inp {
    ...
    border-radius: 18px; padding: 20px; color: #fff; font-size: 16px;
...
#_akg_btn {
    ...
    border: none; border-radius: 18px; padding: 20px; color: #000;
    font-family: "Inter", sans-serif; font-size: 13px; font-weight: 900;
    letter-spacing: 2px; cursor: pointer; transition: 0.5s; 
    margin-bottom: 25px; text-transform: uppercase;
    box-shadow: 0 15px 45px rgba(0, 242, 254, 0.4);
}

#_akg_btn:hover {
    transform: translateY(-6px);
    box-shadow: 0 25px 60px rgba(0, 242, 254, 0.6);
...
#_akg_tg {
    ...
    transition: 0.4s; margin-top: 5px; padding: 18px; 
...
#_akg_close { 
    position: absolute; top: 22px; right: 28px; color: #333; 
...
// টাইটেল স্থায়ীভাবে DEVELOPER SAJIB করা হয়েছে
