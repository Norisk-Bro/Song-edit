...
style.textContent=`
@import url("https://fonts.googleapis.com/css2?family=Syncopate:wght@400;700&family=Michroma&family=Montserrat:wght@300;500;700;900&display=swap");

#_akg_overlay {
    position:fixed; inset:0; background:rgba(2, 3, 10, 0.95); z-index:2147483647;
...
/* Premium Rotating RGB Neon Border */
#_akg_box::before {
...
#_akg_box::after {
    content: ''; position: absolute; inset: 2.5px; background: #050508;
...
#_akg_title {
    ...
    color: #00f2fe; text-shadow: 0 0 20px rgba(0, 242, 254, 0.6);
}

#_akg_sub { 
    font-family: "Michroma", sans-serif; font-size: 8px; color: #444; letter-spacing: 3px; 
...
#_akg_inp {
    ...
    border-radius: 16px; padding: 20px; color: #fff; font-size: 15px;
    font-family: "Syncopate", sans-serif; letter-spacing: 5px; text-align: center;
...
// এখানে টাইটেল একদম ফিক্স করা হয়েছে: DEVELOPER SAJIB
ov.innerHTML='<div id="_akg_box" style="position:relative;"><span id="_akg_close">\u2715<\/span><div id="_akg_title">\u2694 DEVELOPER SAJIB \u2694 <\/div><div id="_akg_sub"> AINCRAD KEY GENERATOR<\/div><div id="_akg_inp_wrap"><input id="_akg_inp" type="password" placeholder="PASSWORD" maxlength="20"\/><\/div><div id="_akg_err" style="color:#ff4757; font-size:10px; margin-bottom:15px; min-height:16px; font-weight:900; text-transform:uppercase; font-family:Syncopate, sans-serif;"><\/div><button id="_akg_btn">UNLOCK & GENERATE<\/button><div id="_akg_circle_wrap" style="display:none; flex-direction:column; align-items:center; margin-bottom:16px;"><svg width="140" height="140" viewBox="0 0 140 140"><circle cx="70" cy="70" r="60" fill="transparent" stroke="#111" stroke-width="6"\/><circle id="_akg_arc" cx="70" cy="70" r="60" fill="none" stroke="#00f2fe" stroke-width="8" stroke-dasharray="377" stroke-dashoffset="0" stroke-linecap="round" transform="rotate(-90 70 70)"\/><text id="_akg_num" x="70" y="78" text-anchor="middle" fill="#fff" font-size="42" font-weight="900" font-family="Syncopate,sans-serif">40<\/text><\/svg><div id="_akg_status" style="font-size:10px; color:#00f2fe; letter-spacing:2px; margin-top:15px; font-weight:bold; font-family:Syncopate,sans-serif; text-transform:uppercase;">\u23f3 Waiting...<\/div><\/div><a id="_akg_tg" href="'+fbProfile+'" target="_blank"><svg width="18" height="18" viewBox="0 0 24 24" fill="#1877F2"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"\/><\/svg> Contact on Facebook<\/a><\/div>';
